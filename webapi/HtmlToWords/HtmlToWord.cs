...
namespace webapi.HtmlToWords
{
    public class HtmlToWord
    {
        public void CreateParts(WordprocessingDocument document, HtmlToWordModel model)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1, model);
            ...
            SetPackageProperties(document, model);
        }

        // Generates content of extendedFilePropertiesPart1.
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1,HtmlToWordModel model)
        {
            ...
            application1.Text =  model.Program_Adi;
            ...
            company1.Text = "Keops10";
            Ap.LinksUpToDate linksUpToDate1 = new Ap.LinksUpToDate();
            linksUpToDate1.Text = "false";
            Ap.CharactersWithSpaces charactersWithSpaces1 = new Ap.CharactersWithSpaces();
            charactersWithSpaces1.Text = "6";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1,HtmlToWordModel model)
        {
            ...
            //Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00D32FA2", RsidRunAdditionDefault = "0044633C", ParagraphId = "78CF42A0", TextId = "5BDE84C0" };
            ...
            PageSize sayfayonlendirme = new PageSize();
            if (model.Sayfa_Yonu == "Yatay")
            {
                sayfayonlendirme = new PageSize() { Width = (UInt32Value)16838U, Height = (UInt32Value)11906U, Orient = PageOrientationValues.Landscape };
            }
            else
            {
                sayfayonlendirme = new PageSize() { Width = (UInt32Value)11906U, Height = (UInt32Value)16838U };
            }

            //SAYFA KENAR BOŞLUKLARI 2.5CM İÇİN 1417.
            // OPENXML ÖLÇÜ BİRİMİ İNÇ CİNSİNDEDİR. 1 İNÇ 2,54CM DİR. 
            // 2.5CM/2,54 = 0.98425 
            // OPENML'DE GENELLİKLE 1/1440 İNÇ BİRİMLERİ KULLANILIR. 
            //0.98425 inç * 1440 = 1417.2
            ...
            if (model.Sayfa_Ust_Kenar_Boslugu != 0)
            {
                Ust = ((model.Sayfa_Ust_Kenar_Boslugu / inc) * 1440);
            }
            if (model.Sayfa_Alt_Kenar_Boslugu != 0)
            {
                Alt = ((model.Sayfa_Alt_Kenar_Boslugu / inc) * 1440);
            }
            if (model.Sayfa_Sag_Kenar_Boslugu != 0)
            {
                Sag = ((model.Sayfa_Sag_Kenar_Boslugu / inc) * 1440);
            }
            if (model.Sayfa_Sol_Kenar_Boslugu != 0)
            {
                Sol = ((model.Sayfa_Sol_Kenar_Boslugu / inc) * 1440);
            }


            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "00D32FA2" };
            PageSize pageSize1 = sayfayonlendirme;
            PageMargin pageMargin1 = new PageMargin() { Top = Convert.ToInt32(Ust), Right = (UInt32Value)Sag, Bottom = Convert.ToInt32(Alt), Left = (UInt32Value)Sol, Header = (UInt32Value)708U, Footer = (UInt32Value)708U, Gutter = (UInt32Value)0U };
            ...
            string htmlEncodedString = model.Belge_Icerigi;
            ...
            AlternativeFormatImportPart formatImportPart = mainDocumentPart1.AddAlternativeFormatImportPart(AlternativeFormatImportPartType.Html, altChunkId);

            formatImportPart.FeedData(ms);
            AltChunk altChunk = new AltChunk();
            altChunk.Id = altChunkId;

            body1.Append(altChunk);
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "003B11AE" };
            Rsid rsid1 = new Rsid() { Val = "003B11AE" };
            Rsid rsid2 = new Rsid() { Val = "0044633C" };
            Rsid rsid3 = new Rsid() { Val = "00D32FA2" };
            Rsid rsid4 = new Rsid() { Val = "00DD414E" };
            Rsid rsid5 = new Rsid() { Val = "00F84E88" };
            ...
            ThemeFontLanguages themeFontLanguages1 = new ThemeFontLanguages() { Val = "tr-TR" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "1B6F8FCD" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{63D97A1C-1BFE-4634-AEA8-57F06B40B810}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Languages languages1 = new Languages() { Val = "tr-TR", EastAsia = "en-US", Bidi = "ar-SA" };
            ...
            Style style2 = new Style() { Type = StyleValues.Character, StyleId = "VarsaylanParagrafYazTipi", Default = true };
            ...
            Style style3 = new Style() { Type = StyleValues.Table, StyleId = "NormalTablo", Default = true };
            ...
            Style style4 = new Style() { Type = StyleValues.Numbering, StyleId = "ListeYok", Default = true };
        ...
        {
            A.Theme theme1 = new A.Theme() { Name = "Office Teması" };
        ...
        private void GenerateFontTablePart1Content(FontTablePart fontTablePart1)
        {
            ...
            FontCharSet fontCharSet1 = new FontCharSet() { Val = "A2" };
            FontFamily fontFamily1 = new FontFamily() { Val = FontFamilyValues.Swiss };
            Pitch pitch1 = new Pitch() { Val = FontPitchValues.Variable };
            FontSignature fontSignature1 = new FontSignature() { UnicodeSignature0 = "E4002EFF", UnicodeSignature1 = "C200247B", UnicodeSignature2 = "00000009", UnicodeSignature3 = "00000000", CodePageSignature0 = "000001FF", CodePageSignature1 = "00000000" };
            ...
            FontCharSet fontCharSet2 = new FontCharSet() { Val = "A2" };
            ...
            FontCharSet fontCharSet3 = new FontCharSet() { Val = "A2" };
        ...
        private void SetPackageProperties(OpenXmlPackage document, HtmlToWordModel model)
        {
            string TSG = DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ssZ");

            document.PackageProperties.Creator = model.Belgeyi_Olusturan;
            document.PackageProperties.Title = model.Baslik;
            document.PackageProperties.Subject = model.Konu;
            document.PackageProperties.Category = model.Kategoriler;
            document.PackageProperties.Keywords = model.Etiketler;
            document.PackageProperties.Description = model.Aciklamalar;
            document.PackageProperties.ContentStatus = model.Durum;
            document.PackageProperties.Revision = "1";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime(TSG, System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime(TSG, System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = model.En_Son_Belgeyi_Duzenleyen;
        }
